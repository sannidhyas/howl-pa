...
function parseArgs(argv: string[]): Args {
  const parsed: Args = { yes: false, keepBackup: false, withDataBackup: false }
...
async function confirmReset(yes: boolean): Promise<void> {
...
function runBackup(withData: boolean): string {
...
function stopDaemonIfActive(): void {
...
function resetFiles(configDir: string): void {
...
function removeSystemdUnit(): void {
  if (!existsSync(UNIT_FILE)) return
