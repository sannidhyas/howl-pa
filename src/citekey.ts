...
function firstAuthorFromAuth(auth: string): string | null {
...
function camelTitle(title: string, maxChunks = 5): string {
...
export function inferCitekey(filename: string, firstPageText?: string): string | null {
...
export function literaturePathFor(citekey: string): string {
