...
function preview(text, start, end) {
...
export function scanForSecrets(text) {
    return [...scanPlain(text), ...scanBase64(text), ...scanUrl(text)].sort((a, b) => a.start - b.start);
}
...
//# sourceMappingURL=exfiltration-guard.js.map