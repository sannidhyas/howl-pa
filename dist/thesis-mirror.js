...
function citekeyFromText(filename, text) {
...
function buildStub(citekey, filename, callout) {
...
function insertOrReplaceCallout(existing, callout) {
...
async function commitVaultFile(vaultRelPath, op) {
    try {
...
export async function mirrorThesis(opts = {}) {
    const out = { scanned: 0, created: 0, updated: 0, skipped: 0, errored: 0, errors: [] };
...
//# sourceMappingURL=thesis-mirror.js.map